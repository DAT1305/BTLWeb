...
let UserHeadChange = document.querySelector('.head-user-items');
  ...
  let user = JSON.parse(localStorage.getItem('user'));
    let html = `
      <div class = "head-user-avata">
                ...
                <div class = "head-user-name"><button>${user.username}</button>
    ...
    UserHeadChange.insertAdjacentHTML('beforeend' , html);
