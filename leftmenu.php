...
<body >
    <div class="container-left" style="position:sticky ; top: 0;">
        
            <div class = "home-button">
                 <a href="index.php" class = "head-return"><svg width = "20px" xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 42 42">
...
<div class="create-button">
 <a href="postcreate.php" class = "head-calendar"><svg xmlns="http://www.w3.org/2000/svg" width="20px" height="30" viewBox="0 0 512 512"><path fill="#000000" d="M256 0Q150 0 75 75T0 256t75 181t181 75t181-75t75-181t-75-181T256 0zm0 469q-88 0-150.5-62.5T43 256t62.5-150.5T256 43t150.5 62.5T469 256t-62.5 150.5T256 469zm107-234h-86v-86q0-21-21-21t-21 21v86h-86q-21 0-21 21t21 21h86v86q0 21 21 21t21-21v-86h86q21 0 21-21t-21-21z"/></svg>tạo bài viết</a>

</div>
 <div class = "group-button">
    <a href="communities.php" class = "head-group"><svg width = "20px" xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 1200 1200">
 ...
 <div class="home-button">
        <a href="#" class = "head-return"><svg width = "20px" xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 20 20">
 ...
 <div class = "home-button">
                 <a href="index.php" class = "head-return"> <svg width = "20px" xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 24 24">
