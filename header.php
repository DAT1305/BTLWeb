...
<header style="margin-bottom: 20px;">
    <div class = "Header-container">
        ...
        <div class = "head-mid-items">
            <!-- nút về trang chủ  -->
            <a href="#" class = "head-return"><svg width = "30px" xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 42 42">
    <path fill="currentColor" d="M2.68 15.726c-.1.039-.16.09-.18.149l.18-.149zm-.18.149v20.627c0 2.509.49 2.998 3 2.998h7c2.51 0 3-.461 3-3v-8h9v8.031c0 2.51.51 2.979 3 2.969c.04.031 7 0 7 0c2.529 0 3-.526 3-2.997V16.495c0-.08-.09-.15-.27-.23L20 1.5L2.68 15.726l-.18.149z"/>
            ...
            <a href="#" class = "head-calendar"><svg width = "30px" width="200" height="200" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <path fill="currentColor" d="M2 19c0 1.7 1.3 3 3 3h14c1.7 0 3-1.3 3-3v-8H2zM19 4h-2V3c0-.6-.4-1-1-1s-1 .4-1 1v1H9V3c0-.6-.4-1-1-1s-1 .4-1 1v1H5C3.3 4 2 5.3 2 7v2h20V7c0-1.7-1.3-3-3-3"/>
            ...
            <a href="#" class = "head-group"><svg width = "30px" xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 1200 1200">
